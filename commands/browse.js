        ...
        .then((atms) => {
          ...
          bot.sendMessage(chatId, msg, {
            reply_markup: JSON.stringify({
              inline_keyboard: [[
                { text: '←', callback_data: JSON.stringify({ type: 'NAV', t: total, d: -1, c: 0, l: [location[0], location[1]] }) },
